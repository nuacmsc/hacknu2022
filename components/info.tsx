    ...
    <section id="about">
        <div className="gap-16 items-center py-16 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div className="sm:text-lg text-gray-700">
                ...
                <h2 className="my-4 text-4xl tracking-tight font-bold text-gray-900">NU ACM SC supports the IT movement among young people in Kazakhstan
                </h2>
                ...
                <p>By participating in HackNU, you get a chance to compete for the main cash prize, as well as gain invaluable experience and meet like-minded people while testing your programming knowledge.</p>
            </div>
